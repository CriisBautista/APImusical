				...
				<!-- Note: The "styleN" class below should match that of the header element. -->
					<section id="banner" class="style2">
						<div class="inner">
							...
							<header class="major">
								<h1>Repertorio de Letras de Canciones</h1>
							</header>
							<div class="content">
								<p>Aquí podrás encontrar información de la letra de tu cancion favorita</p>
							</div>
						</div>
					</section>
							...
							@foreach($letra as $lyrics)
								<section>
									...
									<div class="content">
										<div class="inner">
											<header class="major">
												<h3>{{$lyrics['Nombre_cancion']}}</h3>
											</header>
                                            <h3>LETRA</h3>
											<p style='text-align: justify'>{{$lyrics['Letra']}}</p>
                                            <h4>ID del cantante: {{$lyrics['Cantante']}}</h4>
										</div>
									</div>
								</section>
								@endforeach
